...
* big name options, facebook messanger, whats app, telegram, are more secure than old options, the first two actually use the signal protocol, but these options are still owned by big, for profit companies. consider your threat profile when going this route!
...
5) Conclusion
* using these ideas will make you more secure and private online, and best of all, will help you understand what you're exposing yourself to when you're online. (the real lesson)
