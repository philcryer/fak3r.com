...
date: 2015-07-10
tags: ['howto', 'firefox', 'dnt', 'do not track', 'geek']
authors: ['fak3r']
draft: false
image: ''
---
...
Besides actively blocking tracking, this supposedly speeds up browsing a bit too. Win, win. Thanks again to Mozilla, the only browser that _really_ puts the user first, and hey, it's also the only open source browser out there.
