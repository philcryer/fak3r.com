---
title: 'Graphene OS'
description: "Spoiler: everything mostly just works, don't be scared"
image: 'me-and-graphene.webp'
date: 2024-05-22
tags: ['android', 'linux', 'privacy']
authors: ['fak3r']
draft: false
---
...
Graphene OS is the best Android ROM I've ever installed and it has been my daily driver now for over two months. While some applications may require some tweaking to get functioning as needed, this helps educate the user on how their data is used, while providing a real way forward to having the app's originaly functionality. Yes it'd be amazing if you could avoid installing _any_ Google software; and it is possible, but you're serverly limited to using most popular applications, this is the next best thing, allowing the user full control (and again, understanding) of their personal data. Highly recommended.
