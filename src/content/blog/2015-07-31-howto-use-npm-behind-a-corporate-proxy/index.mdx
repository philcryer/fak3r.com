...
image: 'npm.png'
date: 2015-07-31
tags: ['howto', 'infosec', 'firewall', 'proxy']
authors: ['fak3r']
draft: false
---
...
Reminds me that I need to host more stuff in my basement, aka **/r/homelab** always so fun to hack and learn without such distractions.
