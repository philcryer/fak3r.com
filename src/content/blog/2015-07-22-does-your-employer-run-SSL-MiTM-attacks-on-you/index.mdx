...
authors: ['fak3r']
draft: false
image: 'owasp-man_in_the_middle.jpg'
---
...
![](ssl-mitm-screenshot.png)

SSL decryption uses the Man In The Middle (MitM) method. One picture is worth 1000s words, eh?
